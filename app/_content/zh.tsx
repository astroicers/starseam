...
export const zh: Dictionary = {
  ...
  structure: {
    ...
    prose: {
      note: "長文排版——裁決 12。內文退到第二階的墨,章節靠接縫切分,連結用鉚釘標記。",
      heading: "接縫處的章節",
      lead: "內文是底色,標題與強調才回到全墨。章節的切分靠一條髮絲縫,不靠字級表演。",
      bodyA: "行內代碼像 ",
      bodyB: " 一樣是一小片板;",
      linkText: "連結是兩份文件的接縫",
      bodyC: ",所以用鉚釘的顏色標記,不用瑠璃。",
      quote: "長文就是一份報告——即使在夜勤的主控台上讀。",
    },
    ledger: {
    ...
    glyph: {
      note: "字形集:24 格上的髮絲儀表記號,方切線帽——是裁的,不是鑄的。單色 currentColor,記號本身永不承載嚴重度。",
    },
    scrollArea: {
