...
| `text-2` / ground | 9.47 ✅ | 6.29 ✅ | 4.5 |
| `text-3` / ground | 6.59 ✅ | 5.49 ✅ | 4.5 |
| `text-3` / plate-2 | 6.01 ✅ | 6.16 ✅ | 4.5 |
| `text-3` / plate-3 | 5.65 ✅ | 6.42 ✅ | 4.5 |
...
v0.4.0 再把 `text-2` 與 `text-3` 整組拉離 AA 下限:合格不等於舒服,
黒漆底上的感知亮度低於對比值所暗示,次要文字改以 ≥5.5:1 為舒適線。
